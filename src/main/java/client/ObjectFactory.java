...
public class ObjectFactory {
    ...
    private final static QName _SayHelloResponse_QNAME = new QName("http://test/", "sayHelloResponse");
    private final static QName _SayGoodbye_QNAME = new QName("http://test/", "sayGoodbye");
    private final static QName _SayGoodbyeResponse_QNAME = new QName("http://test/", "sayGoodbyeResponse");
    private final static QName _SayHello_QNAME = new QName("http://test/", "sayHello");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://test/", name = "sayHelloResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://test/", name = "sayGoodbye")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://test/", name = "sayGoodbyeResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://test/", name = "sayHello")
