 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://test/", wsdlLocation = "http://localhost:8077/Service/HelloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://test/", "HelloServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8077/Service/HelloService?wsdl");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://test/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://test/", "HelloServicePort"), HelloService.class, features);
    }
