...
public interface ChinaStockWebServiceSoap {
    ...
    @RequestWrapper(localName = "getStockImageByCode", targetNamespace = "http://WebXml.com.cn/", className = "weather.GetStockImageByCode")
    @ResponseWrapper(localName = "getStockImageByCodeResponse", targetNamespace = "http://WebXml.com.cn/", className = "weather.GetStockImageByCodeResponse")
    ...
    @RequestWrapper(localName = "getStockImageByteByCode", targetNamespace = "http://WebXml.com.cn/", className = "weather.GetStockImageByteByCode")
    @ResponseWrapper(localName = "getStockImageByteByCodeResponse", targetNamespace = "http://WebXml.com.cn/", className = "weather.GetStockImageByteByCodeResponse")
    ...
    @RequestWrapper(localName = "getStockImage_kByCode", targetNamespace = "http://WebXml.com.cn/", className = "weather.GetStockImageKByCode")
    @ResponseWrapper(localName = "getStockImage_kByCodeResponse", targetNamespace = "http://WebXml.com.cn/", className = "weather.GetStockImageKByCodeResponse")
    ...
    @RequestWrapper(localName = "getStockImage_kByteByCode", targetNamespace = "http://WebXml.com.cn/", className = "weather.GetStockImageKByteByCode")
    @ResponseWrapper(localName = "getStockImage_kByteByCodeResponse", targetNamespace = "http://WebXml.com.cn/", className = "weather.GetStockImageKByteByCodeResponse")
    ...
    @RequestWrapper(localName = "getStockInfoByCode", targetNamespace = "http://WebXml.com.cn/", className = "weather.GetStockInfoByCode")
    @ResponseWrapper(localName = "getStockInfoByCodeResponse", targetNamespace = "http://WebXml.com.cn/", className = "weather.GetStockInfoByCodeResponse")
